...
$config['CacheMemcacheAdapter']['Sifo'] = 'libs/Sifo/Cache/MemcacheAdapter.php';
...
$config['DebugSphinxql']['Sifo'] = 'libs/Sifo/Debug/Sphinxql.php';
...
$config['Sphinxql']['Sifo'] = 'libs/Sifo/Sphinxql.php';
...
$config['DebugCommandLineDebugController']['Common'] = 'instances/common/controllers/debug/commandLineDebug.php';
$config['debug/index']['Common'] = 'Alex\\Common\\Controller\\Debug\\IndexController';
$config['DebugMailController']['Common'] = 'instances/common/controllers/debug/mail.php';
$config['error/common']['Common'] = 'Alex\\Common\\Controller\\Error\\CommonController';
$config['home/index']['Common'] = 'Alex\\Common\\Controller\\Home\\IndexController';
$config['I18nActionsController']['Common'] = 'instances/common/controllers/i18n/actions.php';
$config['I18nRebuildController']['Common'] = 'instances/common/controllers/i18n/rebuild.php';
$config['I18nSaveController']['Common'] = 'instances/common/controllers/i18n/save.php';
$config['I18nStatusController']['Common'] = 'instances/common/controllers/i18n/status.php';
$config['LocalesIndexController']['Common'] = 'instances/common/controllers/locales/index.php';
$config['LocalesSaveController']['Common'] = 'instances/common/controllers/locales/save.php';
$config['ManagerFindi18nController']['Common'] = 'instances/common/controllers/manager/findi18n.php';
$config['ManagerRebuildController']['Common'] = 'instances/common/controllers/manager/rebuild.php';
...
$config['ManagerTemplateLauncherController']['Common'] = 'instances/common/controllers/manager/templateLauncher.php';
...
$config['SharedAdvertisingController']['Common'] = 'Alex\\Common\\Controller\\Shared\\AdvertisingController';
$config['SharedCommandLineController']['Common'] = 'instances/common/controllers/shared/commandLine.php';
$config['SharedFirstLevelController']['Common'] = 'instances/common/controllers/shared/firstLevel.php';
$config['SharedFooterController']['Common'] = 'Alex\\Common\\Controller\\Shared\\FooterController';
$config['SharedHeadController']['Common'] = 'Alex\\Common\\Controller\\Shared\\HeadController';
$config['SharedHeaderController']['Common'] = 'Alex\\Common\\Controller\\Shared\\HeaderController';
$config['SharedSystemMessagesController']['Common'] = 'Alex\\Common\\Controller\\Shared\\SystemMessagesController';
$config['StaticIndexController']['Common'] = 'instances/common/controllers/static/index.php';
$config['UserLoginController']['Common'] = 'instances/common/controllers/user/login.php';
$config['I18nTranslatorModel']['Common'] = 'instances/common/models/i18n/translator.php';
$config['OAuthTwitterModel']['Common'] = 'instances/common/models/OAuth/twitter.php';
