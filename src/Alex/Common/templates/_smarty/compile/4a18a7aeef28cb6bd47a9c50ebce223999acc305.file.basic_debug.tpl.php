<?php /* Smarty version Smarty-3.1-DEV, created on 2014-01-10 19:11:47
         compiled from "/home/alexgt9/code/common-sifo/src/Common/templates/debug/basic_debug.tpl" */ ?>
<?php /*%%SmartyHeaderCode:182546548152d037e3dcfce1-10010368%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4a18a7aeef28cb6bd47a9c50ebce223999acc305' => 
    array (
      0 => '/home/alexgt9/code/common-sifo/src/Common/templates/debug/basic_debug.tpl',
      1 => 1389283444,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '182546548152d037e3dcfce1-10010368',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52d037e410d6a8_55793712',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d037e410d6a8_55793712')) {function content_52d037e410d6a8_55793712($_smarty_tpl) {?><?php if (!is_callable('smarty_block_t')) include '/home/alexgt9/code/common-sifo/src/../vendor/alexgt9/Smarty-sifo-plugins/block.t.php';
if (!is_callable('smarty_modifier_number_format')) include '/home/alexgt9/code/common-sifo/src/../vendor/alexgt9/Smarty-sifo-plugins/modifier.number_format.php';
...
<?php  $_smarty_tpl->tpl_vars['controller'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['controller']->_loop = false;
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['controllers']['index']=-1;
...
$_smarty_tpl->tpl_vars['controller']->_loop = true;
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['controllers']['index']++;
?>
	<h3 id="cont_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['controllers']['index'];?>
"><a class="debug_toggle_view" rel="cont_content_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['controllers']['index'];?>
<?php echo (($tmp = @$_smarty_tpl->tpl_vars['execution_key']->value)===null||$tmp==='' ? '' : $tmp);?>
" href="#"><?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['controllers']['index']+1;?>
. <?php echo $_smarty_tpl->tpl_vars['controller_name']->value;?>
</a></h3>
	<div id="cont_content_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['controllers']['index'];?>
<?php echo (($tmp = @$_smarty_tpl->tpl_vars['execution_key']->value)===null||$tmp==='' ? '' : $tmp);?>
" class="debug_contents">
<?php  $_smarty_tpl->tpl_vars['content'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['content']->_loop = false;
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['controllerparams']['index']=-1;
foreach ($_from as $_smarty_tpl->tpl_vars['content']->key => $_smarty_tpl->tpl_vars['content']->value) {
$_smarty_tpl->tpl_vars['content']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['content']->key;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['controllerparams']['index']++;
?>
<?php if ($_smarty_tpl->tpl_vars['key']->value=="CONTROLLER") {?>
	<h4><a class="debug_toggle_view" rel="params_cont_content_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['controllers']['index'];?>
_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['controllerparams']['index'];?>
<?php echo (($tmp = @$_smarty_tpl->tpl_vars['execution_key']->value)===null||$tmp==='' ? '' : $tmp);?>
" href="#">Controller parameters</a></h4>
	<div id="params_cont_content_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['controllers']['index'];?>
_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['controllerparams']['index'];?>
<?php echo (($tmp = @$_smarty_tpl->tpl_vars['execution_key']->value)===null||$tmp==='' ? '' : $tmp);?>
" class="debug_contents">
	<ul>
...
<?php } else { ?>
	...
	<h4><a class="debug_toggle_view" rel="assigns_cont_content_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['controllers']['index'];?>
_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['controllerparams']['index'];?>
<?php echo (($tmp = @$_smarty_tpl->tpl_vars['execution_key']->value)===null||$tmp==='' ? '' : $tmp);?>
" href="#">
...
<?php }?>
	...
	<div  id="assigns_cont_content_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['controllers']['index'];?>
_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['controllerparams']['index'];?>
<?php echo (($tmp = @$_smarty_tpl->tpl_vars['execution_key']->value)===null||$tmp==='' ? '' : $tmp);?>
" class="debug_contents">
	<ul>
