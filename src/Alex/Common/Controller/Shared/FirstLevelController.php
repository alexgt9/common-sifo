 ...
 */
abstract class FirstLevelController extends \Sifo\Controller
{
	...
	public function build()
	{
		...
		$this->addModule( 'head', 'SharedHeadController' );
		$this->addModule( 'system_messages', 'SharedSystemMessagesController' );
		$this->addModule( 'header', 'SharedHeaderController' );
		$this->addModule( 'footer', 'SharedFooterController' );
