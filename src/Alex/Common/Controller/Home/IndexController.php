...
namespace Alex\Common\Controller\Home;

use Alex\Common\Controller\Shared\FirstLevelController;
use Alex\Common\Classes\Pagination;

class IndexController extends FirstLevelController
{
	/**
	...
	public function buildCommon()
	{
		...
		$this->addModule( 'ads_google_skyscrapper' , 'SharedAdvertisingController' );
